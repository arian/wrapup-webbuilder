(function (modules) {
    ...
    '1': function (require, module, exports, global) {
        'use strict';
        var prime = require('2'), array = require('3').prototype;
        var uniqueIndex = 0;
    ...
    '4': function (require, module, exports, global) {
        'use strict';
        var prime = require('2'), type = require('5');
    ...
    '6': function (require, module, exports, global) {
        'use strict';
        var $ = require('1'), array = require('3'), slick = require('7');
        ...
        if (!{ valueOf: 0 }.propertyIsEnumerable('valueOf')) {
            ...
            each = function (object, method, context) {
                ...
                while (i--) {
                    key = buggy[i];
                    value = object[key];
                    if (value !== proto[key] && method.call(context, value, key, object) === false)
                        break;
                }
                return object;
            };
    ...
    'f': function (require, module, exports, global) {
        ...
        for (var i = 0, name, method; name = names[i++];)
    ...
    'l': function (require, module, exports, global) {
        ...
        module.exports = prime({
            on: function (event, fn) {
                ...
                if (!events.length || array.indexOf(events, fn) === -1)
                    events.push(fn);
                return this;
            },
